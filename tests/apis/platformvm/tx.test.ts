...
import { Metal, GenesisData } from "../../../src/index"
...
describe("Transactions", (): void => {
  ...
  test("Creation Tx4 using ImportTx", (): void => {
    const txu: UnsignedTx = set.buildImportTx(
      ...
      addrs2,
      importUTXOs,
      { price: 1, capacity: 982818, excess: 17182, timestamp: "2025-01-09T10:41:33Z"},
      { weights: [ 1, 1000, 1000, 4], maxCapacity: 1000000, maxPerSecond: 100000, targetPerSecond: 500000, minPrice: 1, excessConversionConstant: 2164043 },
      true,
      bintools.cb58Decode(PlatformChainID),
      new BN(90),
      assetID,
